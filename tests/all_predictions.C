...
void prediction(TString filename, Bool_t decayfix)
{
   ...
   TTMYield *lYield = 0;
   Int_t idYields[30] = {211,        -211,        321,        -321,       310,         2212, -2212, 3122, 3312, -3312,
                         3334,       -3334,       313,        333,        3124,        3222, 3224,  3214, 3114, 3324,
   ...
   fprintf(fout, " %d \t %d \t %s \t %6f \n", lRatio->GetID1(), lRatio->GetID2(), lRatio->GetTMName().Data(),
