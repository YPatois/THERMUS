                        ...
                        Bool_t volCor = 0, Bool_t quantRes = 1)
{
   ...
   TTMParticleSet set(THERMUS+"/share/Thermus/particles/partlists/PartList_PPB2014_CBHN.txt", true); // -> still OK !!!
   set.InputDecays(THERMUS+"/share/Thermus/particles/default"); // here true means the decays are scaled to sum(BR) = 100%
